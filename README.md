...
CSVファイルから収支データを読み込み、サマリーカード・カテゴリ別集計・ドーナツグラフ・横棒グラフ・一覧テーブルで収支を可視化します。
...
**支出カテゴリ:** `食料費`、`住宅費`、`光熱費`、`通信費`、`交通費`、`日用品`、`医療費`、`娯楽費`、`投資額`、`保険料`、`特別費`、
`寄付金`、`交際費`、`美容費`、`衣服費`、`教養費`、`その他`
